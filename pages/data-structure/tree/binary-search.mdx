...
class BinarySearchTreeNode {
  ...
  remove(value) {
    ...
    if (removeNode.left && removeNode.right) {
      if (removeNode.parent) {
        const minNode = removeNode.right.findMinNode(value)
        minNode.left = removeNode.left
        removeNode.parent = minNode
      } else {
        const minNode = removeNode.right.findMinNode(value)
        minNode.left = removeNode.left
        removeNode.value = removeNode.right.value
        removeNode.left = removeNode.right.left
        if (removeNode.right.right) removeNode.right = removeNode.right.right
      }
  ...
  find(value) {
    ...
    else if (this.value > value && this.left) this.left.find(value)
    else if (this.value < value && this.right) this.right.find(value)
  ...
  findMinNode(value) {
    if (this.value > value) {
      if (this.left) this.left.findMinNode(value)
      else return this
    } else return this
  }
}
